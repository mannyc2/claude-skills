...
**Batch generation**: Run `python ${CLAUDE_PLUGIN_ROOT}/skills/generating-images-with-gemini/templates/batch-generation.py` or see code for batch API patterns - 50% cost reduction

**File management**: [reference/files-api.md](reference/files-api.md) - Upload/reuse large files

**CLI tool**: Run `python ${CLAUDE_PLUGIN_ROOT}/skills/generating-images-with-gemini/cli.py --help` for standalone command-line interface to all templates
