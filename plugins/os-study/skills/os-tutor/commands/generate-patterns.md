...
Read OS chapter files in docs/ and create pattern reference guides in ${CLAUDE_PLUGIN_ROOT}/skills/os-tutor/references/patterns/.
...
5. Create ${CLAUDE_PLUGIN_ROOT}/skills/os-tutor/references/patterns/ directory if it doesn't exist
