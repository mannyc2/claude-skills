...
Create .claude/skills/os-study/references/socratic_prompts.md with question templates organized by pedagogical purpose.
...
6. Output to .claude/skills/os-study/references/socratic_prompts.md